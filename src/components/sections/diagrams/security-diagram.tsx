...
const DiagramNode = ({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) => (
  <Card className="bg-card/70 border-accent/20 p-4 text-center flex flex-col items-center justify-center text-black h-full">
    ...
    <div className="relative w-full text-black font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center justify-center gap-4">
             ...
             <Card className="bg-primary/10 border-primary/50 p-4 text-center flex flex-col items-center justify-center text-black">
                <ShieldCheck className="w-10 h-10 text-primary mb-2"/>
                <p className="font-bold text-base text-primary">Secure Core</p>
                <p className="text-xs text-black/70">Exnus Protocol Smart Contracts</p>
            </Card>
             <div className="w-px h-full bg-border/50 hidden md:block"></div>
        </div>
