...
const roadmapData = [
  ...
  },
  {
    quarter: "Q4 2024",
    title: "Mainnet Alpha",
    description: "The official launch of the Exnus Protocol mainnet with core functionalities.",
    isComplete: false,
  },
  {
    quarter: "Q1 2025",
    title: "DeFi Integration",
    description: "Integration with major DeFi protocols and liquidity pools.",
    isComplete: false,
  },
  {
    quarter: "Q2 2025",
    title: "Governance Module",
    description: "Launch of on-chain governance, empowering the community to shape the future of the protocol.",
    isComplete: false,
  },
];
